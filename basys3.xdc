...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {H[0]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[0]}]
#set_property PACKAGE_PIN V16 [get_ports {H[1]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[1]}]
#set_property PACKAGE_PIN W16 [get_ports {H[2]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[2]}]
#set_property PACKAGE_PIN W17 [get_ports {H[3]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[3]}]
#set_property PACKAGE_PIN W15 [get_ports {H[4]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[4]}]
#set_property PACKAGE_PIN V15 [get_ports {H[5]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[5]}]
#set_property PACKAGE_PIN W14 [get_ports {H[6]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[6]}]
#set_property PACKAGE_PIN W13 [get_ports {H[7]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[7]}]
#set_property PACKAGE_PIN V2 [get_ports {H[8]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[8]}]
#set_property PACKAGE_PIN T3 [get_ports {H[9]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[9]}]
#set_property PACKAGE_PIN T2 [get_ports {H[10]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[10]}]
#set_property PACKAGE_PIN R3 [get_ports {H[11]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {H[11]}]
...
set_property PACKAGE_PIN T1 [get_ports {continue}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {continue}]
        set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {continue}]
...
#        set_property IOSTANDARD LVCMOS33 [get_ports pause]
#set_property PACKAGE_PIN T17 [get_ports continue]                                          
#        set_property IOSTANDARD LVCMOS33 [get_ports continue]
